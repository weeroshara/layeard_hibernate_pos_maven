package lk.ijse.dep.poss.controller;/*
...
public class MainFormController implements Initializable { 
    ...
    /**
     * Initializes the lk.ijse.dep.poss.controller class.
     */
        ...
        if (event.getSource() instanceof ImageView){
            ...
            switch(icon.getId()){
                case "imgCustomer":
                    ...
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.poss.view customers");
                    break;
                case "imgItem":
                    lblMenu.setText("Manage Items");
                    lblDescription.setText("Click to add, edit, delete, search or lk.ijse.dep.poss.view items");
                    break;
                case "imgOrder":
